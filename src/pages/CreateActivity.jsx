...
const validationSchema = Yup.object({
    ...
    maxPlayers: Yup.number().required('Maximum of players is required').min(2, 'At least 2 participants are required'),
    ...
    experienceLevel: Yup.string()
        ...
        .oneOf(['Beginner', 'Intermediate', 'Advanced'], 'Please select an experience level'),
    fees: Yup.string(),
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                let convertedDate = new Date(values.date).toISOString().split('T')[0];
                ...
                toast.error('Create activity was failed. Please enter valid data and try again.', {
                    position: 'top-center',
                    autoClose: 3000,
                    hideProgressBar: true,
                    closeOnClick: true,
            ...
            <ThemeProvider theme={theme}>
                ...
                >
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <Box display='flex' flexDirection='column' alignItems='start' marginBottom={3}>
                            {/* Box 2 - Date, Time, Players */}
                            <Box display='flex' flexDirection='row' justifyContent='space-between' gap={3} width='75%'>
                                {/* Date */}
                                <TextField
                                    fullWidth
                                    sx={{
                        ...
                        <Accordion sx={{ width: '90%', marginBottom: 3 }}>
                            ...
                            >
                                ...
                                <TextField
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    error={formik.touched.contactPhoneNum && Boolean(formik.errors.contactPhoneNum)}
                                    helperText={formik.touched.contactPhoneNum && formik.errors.contactPhoneNum}

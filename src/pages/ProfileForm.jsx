...
import { Box, Button, FormControl, InputLabel, MenuItem, Select, TextField, ThemeProvider } from '@mui/material';
...
const validationSchema = Yup.object({
    phoneNumber: Yup.string().matches(/^\d{10}$/, 'Phone number must be 10 digits, no dashes'),
    dateOfBirth: Yup.date().nullable().max(new Date(), 'Date of birth must be in the past'),
    ...
    experienceLevel: Yup.string().oneOf(['Beginner', 'Intermediate', 'Advanced']),
});
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        >
                            ...
                            <TextField
                                ...
                                helperText={
                                    formik.touched.residentialAddress?.city && formik.errors.residentialAddress?.city
                                }
                            ...
                            <TextField
                                ...
                                helperText={
                                    formik.touched.residentialAddress?.state && formik.errors.residentialAddress?.state
                                }
